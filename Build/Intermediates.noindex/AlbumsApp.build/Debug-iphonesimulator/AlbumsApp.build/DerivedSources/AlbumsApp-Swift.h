...
#ifndef ALBUMSAPP_SWIFT_H
#define ALBUMSAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AlbumsApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9AlbumsApp24AlbumsCollectionViewCell")
...
SWIFT_CLASS("_TtC9AlbumsApp30AlbumsDetailCollectionViewCell")
@interface AlbumsDetailCollectionViewCell : UICollectionViewCell
...
SWIFT_CLASS("_TtC9AlbumsApp26AlbumsDetailViewController")
@interface AlbumsDetailViewController : UIViewController
@property (nonatomic, weak) IBOutlet UICollectionView * _Null_unspecified albumsDetailCollectionView;
- (void)viewDidLoad;
...
@interface AlbumsDetailViewController (SWIFT_EXTENSION(AlbumsApp)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
SWIFT_CLASS("_TtC9AlbumsApp24AlbumsListViewController")
@interface AlbumsListViewController : UIViewController
@property (nonatomic, weak) IBOutlet UICollectionView * _Null_unspecified albumsCollectionView;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface AlbumsListViewController (SWIFT_EXTENSION(AlbumsApp)) <UISearchBarDelegate>
...
@interface AlbumsListViewController (SWIFT_EXTENSION(AlbumsApp)) <UICollectionViewDataSource>
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UICollectionViewCell * _Nonnull)collectionView:(UICollectionView * _Nonnull)collectionView cellForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
@interface AlbumsListViewController (SWIFT_EXTENSION(AlbumsApp)) <UICollectionViewDelegateFlowLayout>
...
SWIFT_CLASS("_TtC9AlbumsApp11AppDelegate")
...
SWIFT_CLASS("_TtC9AlbumsApp13SceneDelegate")
...
SWIFT_CLASS("_TtC9AlbumsApp28SearchCollectionReusableView")
@interface SearchCollectionReusableView : UICollectionReusableView
@property (nonatomic, weak) IBOutlet UISearchBar * _Null_unspecified albumsSearchBar;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
